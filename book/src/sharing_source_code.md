...
As part of complying with the [GNU Affero General Public License (AGPL)](https://github.com/ReUnit3d/ReUnit3d/blob/master/LICENSE), sites that modify and distribute UNIT3D are required to share their source code. This guide provides an easy process for creating a sanitized tarball of your modified source code and encourages you to create and update an "Open Source" page on your site to make this code available.
...
2. **Add the following Markdown content to the page:**
    ...
    Our site runs on a modified version of [UNIT3D](https://github.com/ReUnit3d/ReUnit3d). For more details on the license, visit the [GNU AGPL License](https://github.com/ReUnit3d/ReUnit3d/blob/master/LICENSE).
    ```
